...
public class PatientController {
	...
	@PutMapping("id/{id}/dept/{deptId}")
	public ResponseEntity<?> updatePatient(@PathVariable Long id,@PathVariable Long deptId, @RequestBody Patient model) throws Exception {
		Patient patient = patientService.updatePatient(id,deptId,model);
		return new ResponseEntity<>(patient, HttpStatus.CREATED);
	}
}
