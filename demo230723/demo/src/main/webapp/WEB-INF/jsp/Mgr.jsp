...
<script type="text/javascript">
            var app = angular.module("MgrManagement", []);
 
            //Controller Part
            app.controller("MgrController", function($scope, $http) {
                ...
                $scope.submitMgr = function() {
                    var method = "";
                    var url = "";
                    $http({
                        method : "POST",
                        url : '/mgr/add',
                        data : angular.toJson($scope.mgrForm),
                        headers : {
                            'Content-Type' : 'application/json'
                        }
                    }).then( mgrSuccess, mgrError );
                };
                ...
                function mgrSuccess(response) {
                	viewMgrData();
                }
                
                function mgrError(response) {
...
<head>
<body ng-app="MgrManagement" ng-controller="MgrController">
	<h1>Manager Form</h1>
	<form ng-submit="submitMgr()">
		<table>
			<tr>
				<th>Manager Name :</th>
				<td><input type="text" ng-model="mgrForm.mgrName" /></td>
			</tr>
			<tr>
